...
import { Contained, Hero, Layout } from '../components';

const TerminosPage: React.FC<PageProps> = () => (
  <Layout>
    <Hero notMarginTopOnMobile>
      <Hero.Title>Términos y condiciones</Hero.Title>
    </Hero>

    <Contained>
      <p>
        Estos términos y condiciones describen las reglas y regulaciones para el
        uso del sitio web de CER El Encinar, ubicado en
        https://cerelencinar.com.
      </p>

      <p>
        Al acceder a este sitio web, asumimos que aceptas estos términos y
        condiciones. No continúes usando CER El Encinar si no estás de acuerdo
      ...
      <p>
        ...
        en línea. Al acceder a CER El Encinar, aceptaste utilizar las cookies
        necesarias.
      </p>
      ...
      <p>
        A menos que se indique lo contrario, CER El Encinar y/o sus licenciantes
        poseen los derechos de propiedad intelectual de todo el material en CER
        El Encinar. Todos los derechos de propiedad intelectual son reservados.
        Puedes acceder desde CER El Encinar para tu uso personal sujeto a las
      ...
      <p>
        <ul>
          <li>Copiar o volver a publicar material de CER El Encinar</li>
          <li>Vender, alquilar o sublicenciar material de CER El Encinar</li>
          <li>Reproducir, duplicar o copiar material de CER El Encinar</li>
          <li>Redistribuir contenido de CER El Encinar</li>
        </ul>
      </p>
      ...
      <p>
        ...
        CER El Encinar no filtra, edita, publica ni revisa los comentarios antes
        de su presencia en el sitio web. Los comentarios no reflejan los puntos
        de vista ni las opiniones de CER El Encinar, sus agentes y/o afiliados.
        Los comentarios reflejan los puntos de vista y opiniones de la persona
        que publica. En la medida en que lo permitan las leyes aplicables, CER
        El Encinar no será responsable de los comentarios ni de ninguna
        responsabilidad, daños o gastos causados ​​o sufridos como resultado de
        cualquier uso o publicación o apariencia de comentarios en este sitio
        web.
      </p>

      <p>
        CER El Encinar se reserva el derecho de monitorear todos los comentarios
        y eliminar los que puedan considerarse inapropiados, ofensivos o que
      ...
      <p>
        Por la presente, otorgas a CER El Encinar una licencia no exclusiva para
      ...
      <p>
        ...
        del hipervínculo compensa la ausencia de CER El Encinar; y (d) el enlace
        está en el contexto de información general de recursos.
      </p>
      ...
      <p>
        ...
        un correo electrónico a CER El Encinar. Incluye tu nombre, el nombre de
      ...
      <p>
        No se permitirá el uso del logotipo de CER El Encinar u otro material
...
export const Head: HeadFC = () => (
  <>
    <html lang="es" />
    <title>CER El Encinar - Términos y condiciones</title>
