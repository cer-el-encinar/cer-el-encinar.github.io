...
const ColaboraPage: React.FC<PageProps> = () => (
  <Layout>
    ...
    <Contained>
      ...
      <CallToAction>
        <a href="https://forms.gle/rJqqSoQZUrn1Vonh6" target="_blank">
      ...
      <h4>¿Te gustaría ser parte de esta misión maravillosa?</h4>
      <p>
        Convertirte en voluntario de nuestra asociación de cuidados de colonias
        felinas es una experiencia gratificante que marca la diferencia en la
        vida de estos encantadores mininos.
      </p>
      ...
      <h4>¿Qué puedes hacer como voluntario?</h4>
      <p>
