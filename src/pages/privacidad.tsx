...
const PrivacidadPage: React.FC<PageProps> = () => (
  <Layout>
    <Hero notMarginTopOnMobile>
      <Hero.Title>Política de privacidad</Hero.Title>
    </Hero>

    <Contained>
      <p>
        El sitio web CER El Encinar es propiedad de CER El Encinar, que es un
        controlador de datos de tus datos personales.
      </p>

      <p>
        Hemos adoptado esta Política de privacidad, que determina cómo
        procesamos la información recopilada por CER El Encinar, que también
        ...
        privacidad antes de usar el sitio web de CER El Encinar.
      </p>
      ...
      <p>
        Cuando visitas CER El Encinar, recopilamos automáticamente cierta
        ...
        instaladas en tu dispositivo. Además, a medida que navegas, recopilamos
        información sobre las páginas web individuales o los productos que ves,
        qué sitios web o términos de búsqueda te remitieron a la web y cómo
        interactúas. Nos referimos a esta información recopilada automáticamente
        como "Información del dispositivo". Además, podemos recopilar los datos
        personales que nos proporcionas (incluidos, entre otros, nombre,
        apellido, dirección, información de pago, etc.) durante el registro para
      ...
      <p>
        ...
        la medida en que sea absolutamente necesario para mantener el sitio web.
        La información recopilada automáticamente se utiliza solo para
        identificar casos potenciales de abuso y establecer información
        estadística sobre el uso del sitio web. Esta información estadística no
        se agrega de tal manera que identifique a ningún usuario en particular
        del sistema.
      </p>
      ...
      <p>
        Además, si eres residente europeo, destacamos que estamos procesando tu
        información para cumplir con los contratos que podríamos tener contigo
        (por ejemplo, si realizas un pedido a través de la web), o de otra
        manera para seguir nuestros intereses comerciales legítimos enumerados
        anteriormente. Además, ten en cuenta que tu información puede
      ...
      <p>
        ...
        <a href="mailto:cerelencinar@gmail.com">cerelencinar@gmail.com</a>.
      </p>
    </Contained>
  </Layout>
);
...
export const Head: HeadFC = () => (
  <>
    <html lang="es" />
    <title>CER El Encinar - Política de privacidad</title>
